...
for rep in a b c; do for s in $SC; do run final_$rep v2 $s ""; done; done
run final_inject_stale v2 diagonal inject_stale
run final_inject_supersede v2 longitudinal inject_supersede
echo CAMPAIGN_DONE
