#!/usr/bin/env python3
"""Build the Gen3 wrist-point reachability SDF used by the TRIAD supervisory mode funnel.
...
// GENERATED by supervisory_mode/tools/build_gen3_wrist_reachability.py - do not edit.
